...
import {  MovieOutlined, VisibilityOutlined } from "@mui/icons-material";
  ...
  return (
    <div className="py-5 cbox">
      ...
      <Swiper
        ...
        slidesPerView={2.2} // اعشاری کردن برای نمایش بخشی از اسلاید بعدی
        slidesPerGroup={2}
        navigation
        initialSlide={0}
            ...
            <div className="relative flex flex-col items-center group">
              ...
              >
                <img
                  ...
                  alt={movie.title}
                />
               {activeSlide!==index && <h3 className="text-[1rem] header p-1 rounded-2x yekanh absolute bottom-0 right-2 md:text-[1em] my-1 font-bold text-white">
                  {movie.title}
                </h3>} 
                <h3 className="absolute top-2 right-2 text-[0.8rem] text-white bg-[#1a1a1a] px-2 py-1 rounded-xl">{movie.genre}</h3>
