// این کامپوننت هر اسلاید (کارت) فیلم یا سریال را نمایش می‌دهد، شامل تصویر، اطلاعات و دکمه‌ها
...
function MovieSlide({ movie, index, isLoading, imageLoaded, isActive, onImageClick, onPlayClick }: MovieSlideProps) {
  return (
    <div className="relative flex flex-col items-center group">
      ...
      >
        ...
        <h3 className="absolute top-2 right-2 text-[0.8rem] text-white bg-[#1a1a1a] px-2 py-1 rounded-xl">
          {movie.genre}
        </h3>
