// این کامپوننت هر کارت فیلم را نمایش می‌دهد، شامل تصویر، اطلاعات و دکمه‌ها
...
function MovieCard({ movie, index, isLoading, imageLoaded, isActive, onCardClick, onPlayClick }: MovieCardProps) {
  return (
